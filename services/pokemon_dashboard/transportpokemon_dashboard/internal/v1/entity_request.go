...
// HTTPRequest represents the pokemon_dashboard request on the application layer
//
...
// BodyRequest represents the pokemon_dashboard body request on the application layer
